...
// We don't need once this PR[0] merged.
//  0 - https://github.com/meteor/react-packages/pull/124
...
function getReactDOMServer() {
  if (Package["react-runtime-dev"]) {
    return Package["react-runtime-dev"].ReactDOMServerDev;
  } else if (Package["react-runtime-prod"]) {
    return Package["react-runtime-prod"].ReactDOMServerProd;
  } else {
